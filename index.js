const TelegramApi = require('node-telegram-bot-api'), {gameOptions, againOptions} = require('./options'),
    sequelize = require('./db'), UserModel = require('./models'),
    token = '5120052449:AAHK39DJGIvvLm81cGyP9k-vBtneImBeGcA', bot = new TelegramApi(token, {polling: true}), chats = {},
